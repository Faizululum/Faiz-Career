  ...
  return (
    <div className="flex flex-col gap-6">
      ...
      <div className="text-center text-xs text-muted-foreground text-balance">
        By clicking continue, you agree to our <br />terms and services privacy policy.
      </div>
    </div>
  );
};
